// Shared Tailwind className constants for the Manager/Owner dashboards and the
...
// Card-row list (employees / managers).
...
// Allocation inputs (amount, %, motif).
...
// Amount card (large readout, dark ink-teal with gold Coin).
